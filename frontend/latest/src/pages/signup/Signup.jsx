...
setInputs((prev) => ({ ...prev, gender }));
  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto '>
      <div className='w-full p-6 rounded-lg shadow-md bg-white/10 bg-clip-padding  backdrop-blur-lg bg-opacity-10'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
           ...
           <Link to="/login" className="text-sm  hover:text-blue-500 hover:underline mt-2 inline-block">Already have an account?</Link>
...
//           </div>
//            <a href="#" className="text-sm  hover:text-blue-500 hover:underline mt-2 inline-block">Already have an account?</a>
//     <GenderCheckbox/>
